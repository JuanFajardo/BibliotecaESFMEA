...
<body class="preloader">
	...
	<main>
		<section class="seccion seccion-1" id="inicio">
			...
			<div class="bloque-b">
				<img src="{{asset('assets/img/b.svg')}}" class="imagen-b">
			</div>

			<div class="intro-paso-1">
        <h1>ESCUELA SUPERIOR <br>
        DE FORMACIÓN DE <br>
        MAESTROS "EDUARDO AVAROA"</h1>
			</div>
		...
		<section class="seccion seccion-2"  id="operaciones">
			<div class="container">
				...
				<div class="row borde-verde">
					...
					<div class="bloque-blanco-icono">
						<img src="{{asset('assets/img/operaciones.svg')}}" class="img-operaciones">
					</div>
				</div>
			</div>
			...
			<div class="adorno adorno-1">
				<img src="{{asset('assets/img/recurso_operaciones.png')}}" class="img-adorno">
			</div>
		</section>
