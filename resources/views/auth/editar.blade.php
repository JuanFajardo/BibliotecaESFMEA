...
<br>
  ...
  <div class="row">
    <div class="form-group{{ $errors->has('ci') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        {!! Form::text('ci',  old('ci'), ['id'=>'ci', 'class'=>'form-control', 'required']) !!}
      </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('ci') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        {!! Form::text('nivel',  old('nivel'), ['id'=>'nivel', 'class'=>'form-control', 'required', 'list'=>'lista_nivel']) !!}
      </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('paralelo') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        {!! Form::text('paralelo',  old('paralelo'), ['id'=>'paralelo', 'class'=>'form-control', 'required', 'list'=>'lista_paralelo']) !!}
      </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('reg_estudiante') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        {!! Form::text('reg_estudiante',  old('reg_estudiante'), ['id'=>'reg_estudiante', 'class'=>'form-control', 'required']) !!}
      </div>
    </div>
    <div class="form-group{{ $errors->has('especialidad') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        {!! Form::text('especialidad',  old('especialidad'), ['id'=>'especialidad', 'class'=>'form-control', 'required', 'list'=>'lista_especialidad']) !!}
      </div>
    </div>
  ...
  <div class="row">
    ...
    <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }} col-md-3 col-xl-3">
      <label for="password" class="col-md-6 control-label">Cambiar Clave</label>
      <input id="password" type="password" class="form-control" name="password" placeholder="Deje vacio para no cambiar">
