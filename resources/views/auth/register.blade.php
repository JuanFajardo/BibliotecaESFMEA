...
<form class="form-horizontal" method="POST" action="{{ route('usuarios') }}" autocomplete="false">
  ...
  <div class="row">
    <div class="form-group{{ $errors->has('ci') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        <input id="" type="text" class="form-control" name="ci" value="{{ old('ci') }}" required>
      </div>
    </div>
    ...
    <div class="form-group{{ $errors->has('ap_paterno') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        <input id="" type="text" class="form-control" name="ap_paterno" value="{{ old('ap_paterno') }}" required>
      </div>
    </div>
    <div class="form-group{{ $errors->has('ap_materno') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        <input id="" type="text" class="form-control" name="ap_materno" value="{{ old('ap_materno') }}" required>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        <input id="name" type="email" class="form-control" name="email" value="{{ old('name') }}" >
        @if ($errors->has('email'))
        <span class="help-block">
  ...
  <div class="row">
    ...
    <div class="form-group{{ $errors->has('reg_estudiante') ? ' has-error' : '' }} col-md-3 col-xl-3">
      ...
      <div class="">
        <input id="" type="text" class="form-control" name="reg_estudiante" value="{{ old('reg_estudiante') }}" required>
      </div>
    </div>
